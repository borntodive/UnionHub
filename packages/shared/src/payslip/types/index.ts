...
/** Context about the user, extended beyond simple itud/rsa flags */
export interface UserContext {
  ...
  gradeCode?: string;
  /** Pre-fetched seniority brackets from live API (mobile only) */
...
export interface RankContract {
  ...
  seniorityBrackets?: SeniorityBracket[]; // Optional seniority brackets
}
