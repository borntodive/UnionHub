...
import { u as I, g as w, R as F } from "./usePayslipStore-Bs_U9V_V.js";
const d = (t) =>
                  ...
                  : i.map((o, n) =>
                      e.jsx(
                        c,
                        {
                          ...
                          item: { ...o, isDeduction: !1 },
                        },
                        `ap-${n}`,
                      ),
                    ),
                e.jsx(c, { label: "Sindacato", item: s.union, highlight: !0 }),
                (l = s.additionalDeductions) == null
                  ? void 0
                  : l.map((o, n) =>
                      e.jsx(
                        c,
...
function P({ settings: t, hasRSA: s, hasITUD: i }) {
  const l = w(t.company || "RYR", t.role, t.rank);
  if (!l)
    return e.jsx("div", {
  ...
  const o = t.parttime ? t.parttimePercentage : 1,
    n = t.cu ? F.cuReduction : 1,
    p = t.legacy
      ? t.legacyDirect
        ? t.legacyCustom.ffp
    ...
    b = t.legacy
      ...
      : l.al,
    m = [
      { label: "Stipendio base", value: l.basic * o, unit: "/mese" },
      { label: "FFP", value: p * o * n, unit: "/mese" },
      { label: "SBH rate", value: x, unit: "/ora" },
      { label: "Ferie (AL)", value: b * o, unit: "/giorno" },
  ...
  return (
    ...
    l.allowance &&
      m.push({ label: "Allowance", value: l.allowance * o, unit: "/mese" }),
...
function D({ settings: t }) {
  const [s, i] = y.useState(""),
    [l, o] = y.useState(""),
    n = w(t.company || "RYR", t.role, t.rank),
    ...
    f =
      h !== null
        ? `${Math.floor(h).toString().padStart(2, "0")}:${Math.round(
            (h % 1) * 60,
          )
            .toString()
            .padStart(2, "0")}`
...
function T() {
  const t = I(),
    { user: s } = k(),
    i =
      (s == null ? void 0 : s.role) === N.ADMIN ||
      (s == null ? void 0 : s.role) === N.SUPERADMIN,
    [l, o] = y.useState("input"),
    [n, p] = y.useState(null),
    [x, b] = y.useState(null),
    m = ["fo", "cpt", "ltc", "sfi", "lcc", "tri", "tre", "so", "jfo"],
    u = ["ju", "jpu", "cc", "sepe", "sepi"],
    h = t.settings.role === "pil" ? m : u,
    f = [
    ...
    v = () => {
      const a = {};
      (n !== null && (a.itud = n), x !== null && (a.rsa = x), t.calculate(a));
    },
    j = () =>
      e.jsxs("div", {
        ...
        children: [
          f.map((a) =>
            e.jsx(
              ...
              {
                onClick: () => o(a.id),
                className: `px-4 py-2 text-sm font-medium border-b-2 -mb-px transition-colors ${l === a.id ? "border-[#177246] text-[#177246]" : "border-transparent text-gray-500 hover:text-gray-700"}`,
                children: a.label,
              },
              a.id,
            ),
        ...
        children: [
          e.jsxs("div", {
            ...
            children: [
              ...
              l === "reverse" && e.jsx(D, { settings: t.settings }),
              l === "override" &&
                i &&
                e.jsx(R, {
                  overrideITUD: n,
