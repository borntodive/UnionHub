import { c as q, p as G, a as K } from "./index-lyt0rc2Z.js";
const y = {
  ...
  const a =
    t === "pilot" || t === "pil"
      ? ["cpt", "tre", "tri", "ltc", "lcc"].includes(n)
        ...
        : "fo"
      : "cc";
  return y.unionFees[a] || 0;
}
function tt(n) {
  const t = n === "pilot" || n === "pil" ? "pil" : "cc";
  return y.unpayedLeaveDays[t] || 17;
}
function l(n, t = 100, a = null, i = !1, o = !1) {
  const e = n * (t / 100),
    s = n - e,
    r = a && a > 0 ? n / a : null;
  return {
...
function R(n, t, a) {
  return {
    basicQuota: l(n, 100, a, !0),
    ffpQuota: l(t, 50, a, !0),
    total: l(n + t, 100, a, !0),
  };
}
function T(n, t, a = !1, i = !1) {
  const o = n * (t / 100),
    e = n - o;
...
function ct(n, t) {
  return t === 2024
    ? { ...E(n, t), concorreImponibileIRPEF: !0 }
...
const pt = ["cpt", "ltc", "lcc", "tri", "tre"];
function mt(n) {
  var a;
  const t = ((a = n.gradeCode) == null ? void 0 : a.toLowerCase()) ?? "";
  return pt.includes(t) ? (n.dateOfCaptaincy ?? null) : (n.dateOfEntry ?? null);
}
function ht(n) {
  const t = new Date(n),
    a = t.getFullYear();
  return t.getMonth() + 1 >= 4 ? new Date(a, 3, 1) : new Date(a - 1, 3, 1);
}
function gt(n, t) {
  const a = ht(t),
    i = new Date(n);
  if (i >= a) return 0;
  let o = a.getFullYear() - i.getFullYear();
  const e = a.getMonth() - i.getMonth();
  return (
    (e < 0 || (e === 0 && a.getDate() < i.getDate())) && o--,
    Math.max(0, o)
  );
}
function bt(n, t) {
  return (
    n.find(
      (a) => t >= a.minYears && (a.maxYears === null || t <= a.maxYears),
    ) ?? null
  );
}
function yt(n, t) {
  return {
    ...n,
    ...(t.basic !== void 0 && { basic: t.basic }),
    ...(t.ffp !== void 0 && { ffp: t.ffp }),
    ...(t.sbh !== void 0 && { sbh: t.sbh }),
    ...(t.al !== void 0 && { al: t.al }),
    ...(t.oob !== void 0 && { oob: t.oob }),
    ...(t.diaria !== void 0 && { diaria: t.diaria }),
    ...(t.rsa !== void 0 && { rsa: t.rsa }),
    ...(t.itud !== void 0 && { itud: t.itud }),
    ...(t.allowance !== void 0 && { allowance: t.allowance }),
    ...(t.woff !== void 0 && { woff: t.woff }),
  };
}
const m = (n) => Math.round(n * 100) / 100;
class F {
  constructor(t, a, i = {}) {
    ((this.seniorityYears = 0),
      (this.input = F.sanitizeInput(t)),
      (this.settings = a),
      (this.userFlags = i),
      (this.year = ft(t.date)),
      (this.month = new Date(t.date).getMonth() + 1));
    const o = S(a.company, a.role, a.rank);
    if (o) {
      const e = J(a.company, a.role, t.date),
        s = Z(o, e, a.rank);
      if (!s) {
      ...
      if (u) {
        const c = gt(u, t.date);
        this.seniorityYears = c;
        const f = i.seniorityBrackets ?? s.seniorityBrackets;
        if (f && f.length > 0) {
          const d = bt(f, c);
          d && (r = yt(s, d));
        }
      ...
      if (a.legacy) {
        const c = a.legacyCustom,
          f = a.legacyDeltas;
        a.legacyDirect && c
          ? (this.contractData = {
              ...r,
              ffp: c.ffp > 0 ? c.ffp : r.ffp,
              sbh: c.sbh > 0 ? c.sbh : r.sbh,
              al: c.al > 0 ? c.al : r.al,
            })
          : f
            ? (this.contractData = {
            ...
            : (this.contractData = r);
      } else this.contractData = r;
    } else this.contractData = null;
  }
  static sanitizeInput(t) {
    const a = (i) => Math.max(0, isFinite(i) ? i : 0);
    return {
      ...t,
      flyDiaria: a(t.flyDiaria),
      noFlyDiaria: a(t.noFlyDiaria),
      al: a(t.al),
      woff: a(t.woff),
      oob: a(t.oob),
      ul: a(t.ul),
      parentalDays: a(t.parentalDays),
      days104: a(t.days104),
      trainingSectors: a(t.trainingSectors),
      simDays: a(t.simDays),
      itud: a(t.itud),
      oobUnplanned: a(t.oobUnplanned),
      ccTrainingDays: a(t.ccTrainingDays),
      commissions: a(t.commissions),
      bankHolydays: a(t.bankHolydays),
      inpsDays: a(t.inpsDays),
    };
  }
  async calculatePayroll() {
    ...
    const t = this.calculatePayslipItems(),
      ...
      u = this.calculateFondoPensione(r.retribuzioneUtileTFR),
      c = this.calculateIRPEF(i, s, t.additionalPayments);
    ((c.fondoPensione = u),
      (c.retribuzioneUtileTFR = r.retribuzioneUtileTFR),
      (c.tfr = r.tfr));
    const f = e + s.esenzioneIVS.amount + c.trattamentoIntegrativo,
      d =
        s.contribuzioneTotale +
        c.ritenute +
        c.fondoPensione.volontaria +
        c.addizionaliRegionali +
        c.addizionaliComunali +
        c.accontoAddizionaliComunali,
      h = m(f - d);
    return {
      payslipItems: t,
      sectorPay: a,
  ...
  calculatePayslipItems() {
    ...
    const t = this.contractData,
      ...
      o = t.basic * a * i,
      e = l(o, 100, t.basicDays || 1),
      s = dt(this.input.date) ? l(o, 100) : l(0, 100),
      r = this.calculateFFP(a, i),
      u = l(r, 50),
      c = nt(this.input.flyDiaria, t.diaria, W),
      f = {
        total: c.total,
        taxable: c.taxable,
        taxFree: c.taxFree,
      ...
      d = l(this.input.noFlyDiaria * t.diaria, 100, this.input.noFlyDiaria),
      h = l(this.input.al * t.al * i, 50, this.input.al),
      D = t.woff
        ? l(t.woff * this.input.woff * i, 50, this.input.woff)
        : l(0, 50),
      w = l(this.input.oob * t.oob, 100, this.input.oob),
      P = this.userFlags.rsa ? l(t.rsa, 100) : l(0, 100),
      b = t.oob
        ? l(this.input.oobUnplanned * t.oob, 100, this.input.oobUnplanned)
        : l(0, 100),
      v = this.calculateLeave(this.input.ul, e.total, u.total, !1),
      I = l(this.calculateSimPay() * i, 50, this.input.simDays),
      L = l(this.calculateTrainingPay() * i, 50, this.input.trainingSectors),
      M = this.calculateLeave(this.input.parentalDays, e.total, u.total, !0),
      B = this.calculateLeave(this.input.days104, e.total, u.total, !0),
      x = ut(this.input.sbh),
      Y = l(x * t.sbh, 50, x),
      U = t.itud || 120,
      N = l(this.input.itud * U, 50, this.input.itud),
      _ = this.input.additional.map((p) =>
        T(p.amount, p.tax, p.isSLR, p.isConguaglio),
      ),
      O = this.input.additionalDeductions.map((p) =>
        T(p.amount, p.tax, !1, p.isConguaglio),
      ),
      k = $(this.settings.rank, this.settings.role),
      Q = l(k, 0, 1, !0),
      j = l(this.input.commissions * i, 100),
      H = l(this.input.bankHolydays * t.al, 50, this.input.bankHolydays),
      V = l(
        this.input.ccTrainingDays *
          (((A = t.training) == null ? void 0 : A.allowance) || 0) *
          i,
        50,
        this.input.ccTrainingDays,
      );
    return {
      ...
      sbh: Y,
      itud: N,
      additionalPayments: _,
      additionalDeductions: O,
      union: Q,
      commissions: j,
      bankHolydays: H,
    };
  ...
  calculateFFP(t = 1, a = 1) {
    ...
    if (
      ...
      const u = i.training;
      this.settings.btc && u.btc
        ? (o += u.btc.allowance)
        : u.nonBtc && (o += u.nonBtc.allowance);
    }
    if (this.settings.rank === "tre" || this.settings.triAndLtc) {
      const u = S(this.settings.company, this.settings.role, "ltc");
      (r = u == null ? void 0 : u.training) != null &&
        r.allowance &&
        (o += u.training.allowance);
    }
    return o;
  }
  calculateSimPay() {
    ...
    if (
      ...
      return 0;
    const { sectorPay: i } = it(this.input.simDays, a);
    return i;
  }
  calculateTrainingPay() {
    ...
    return (
      ...
      at(t, this.contractData.training.bonus.pay)
    );
  }
  calculateLeave(t, a, i, o) {
    if (t === 0)
      return {
        basicQuota: l(0, 100, 0, !0),
        ffpQuota: l(0, 50, 0, !0),
        total: l(0, 100, 0, !0),
      };
    if (o) {
  ...
  calculateINPS(t) {
    const i = (X[this.year] || 56.87) * this.input.inpsDays,
      o = Math.max(t, i),
      e = {
        ivs: m(o * g.ivs),
        ivsAdd: m(o * g.ivsAdd),
  ...
  calculateIRPEF(t, a, i) {
    const o = a.contribuzioneTotale,
      e = i.filter((b) => b.isSLR).reduce((b, v) => b + v.total, 0),
      s = t - o + e,
      r = s * 12,
      u = C[this.year] || C[2024],
      c = ot(r, u),
      f = st(r, this.year, new Date(this.input.date)) * 30,
      d = this.settings.coniugeCarico ? rt(r, this.year) : 0,
      h = E(s, this.year),
      D = m(Math.max(0, c - f - d - h.amount)),
      w = s > 0 ? D / s : 0,
      P = lt(r, c, f + d, new Date(this.input.date));
    return {
      imponibile: s,
      lordo: c,
...
async function Dt(n, t, a = {}) {
  return new F(n, t, a).calculatePayroll();
}
const z = {
  ...
  vt = q()(
    G(
      (n, t) => ({
        ...
        reset: () => n({ input: { ...z }, result: null, error: null }),
...
export { y as R, S as a, gt as c, mt as g, vt as u };
