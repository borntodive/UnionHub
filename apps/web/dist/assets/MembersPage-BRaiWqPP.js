...
import { b as Ee, c as Ae, g as Me } from "./references-Bs44Uh4F.js";
import { P as Fe } from "./plus-CwPhpPm0.js";
import { U as Te } from "./upload-CfyOW7on.js";
import { D as Be } from "./download-BzleaX6g.js";
import { S as Oe } from "./search-DpbBdbbn.js";
import { M as Le, P as Ue, C as T } from "./phone-B6MTJ9QU.js";
import { C as $e } from "./chevron-down-D6qAXTIH.js";
var qe = class extends je {
  ...
  createResult(t, r) {
    ...
    const { state: l } = t,
      ...
      { isFetching: m, isRefetching: N, isError: c, isRefetchError: p } = d,
      x =
        (I = (y = l.fetchMeta) == null ? void 0 : y.fetchMore) == null
          ? void 0
          : I.direction,
      z = c && x === "forward",
      k = m && x === "forward",
 ...
 */ const _e = O("SlidersHorizontal", [
  ...
  xe = 25,
  ue = (t) =>
    t === v.PILOT ? "Pilota" : t === v.CABIN_CREW ? "Cabin Crew" : "—",
  he = (t) =>
    t === v.PILOT
...
function g({ icon: t, label: r, value: l }) {
  return l
    ? e.jsxs("div", {
        className:
            ...
            e.jsxs("div", {
              ...
              children: [
                ...
                e.jsx(g, {
                  ...
                  label: "Contratto",
                  value: (m = t.contratto) == null ? void 0 : m.nome,
                }),
                e.jsx(g, {
                  icon: e.jsx(ze, { size: 14 }),
                  label: "Grado",
                  value: (N = t.grade) == null ? void 0 : N.nome,
                }),
                e.jsx(g, {
                  icon: e.jsx(T, { size: 14 }),
                  label: "Iscrizione",
                  value: B(t.dataIscrizione),
                }),
                e.jsx(g, {
                  icon: e.jsx(T, { size: 14 }),
                  label: "Ingresso",
                  value: B(t.dateOfEntry),
                }),
                e.jsx(g, {
                  icon: e.jsx(T, { size: 14 }),
                  label: "Capitano dal",
                  value: B(t.dateOfCaptaincy),
                }),
                e.jsx(g, {
                  icon: e.jsx(T, { size: 14 }),
                  label: "Registrato",
...
function at() {
  ...
  const t = ke((s) => s.user),
    ...
    [c, p] = o.useState(""),
    x = o.useMemo(() => ({ timer: 0 }), []);
  o.useEffect(() => () => clearTimeout(x.timer), [x]);
  const z = (s) => {
      (N(s),
        clearTimeout(x.timer),
        (x.timer = window.setTimeout(() => p(s), 300)));
    },
    [k, E] = o.useState(!1),
    [f, L] = o.useState(),
    [y, I] = o.useState(),
    [S, H] = o.useState(),
    [A, X] = o.useState(),
    [u, ge] = o.useState({ key: "cognome", dir: "asc" }),
    C = (s) =>
      ge((a) => ({
        key: s,
        ...
        s.sort((a, i) => {
          ...
          switch (u.key) {
            case "nome":
              ...
              break;
            case "cognome":
              ((n = a.cognome ?? ""), (j = i.cognome ?? ""));
              break;
            case "ruolo":
              ((n = a.ruolo ?? ""), (j = i.ruolo ?? ""));
              break;
            case "base":
              ((n = ((ae = a.base) == null ? void 0 : ae.codice) ?? ""),
                (j = ((oe = i.base) == null ? void 0 : oe.codice) ?? ""));
              break;
            case "grade":
              ((n = ((le = a.grade) == null ? void 0 : le.nome) ?? ""),
                (j = ((ie = i.grade) == null ? void 0 : ie.nome) ?? ""));
              break;
            case "contratto":
              ((n = ((ne = a.contratto) == null ? void 0 : ne.nome) ?? ""),
                (j = ((ce = i.contratto) == null ? void 0 : ce.nome) ?? ""));
              break;
          }
          return u.dir === "asc"
            ? n.localeCompare(j, "it")
            : j.localeCompare(n, "it");
        }),
        s
      );
    }, [ee, u]),
    M = [f, y, S, A].filter(Boolean).length,
    fe = () => {
      (L(void 0), I(void 0), H(void 0), X(void 0));
    },
    ye = async () => {
      try {
        const s = await _.exportCsv({ ruolo: f, baseId: y, contrattoId: S }),
    ...
    be = async (s) => {
      var i;
      const a = (i = s.target.files) == null ? void 0 : i[0];
      if (a) {
        (se(!0), G(null));
        try {
          const n = await _.bulkImport(a);
          (G(n), d.invalidateQueries({ queryKey: ["members"] }));
        } catch {
    ...
    children: [
      e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [
                    ...
                    e.jsxs("div", {
                      ...
                      children: [
                        ...
                        !r &&
                          ...
                          e.jsx("span", {
                            className: `text-xs font-medium px-2 py-0.5 rounded-full ${t.ruolo === v.PILOT ? "bg-blue-50 text-blue-700 border border-blue-200" : "bg-purple-50 text-purple-700 border border-purple-200"}`,
                            children:
                              t.ruolo === v.PILOT ? "Piloti" : "Cabin Crew",
                          }),
                      ],
                    }),
                    e.jsxs("p", {
                ...
                e.jsxs("div", {
                  ...
                  children: [
                    ...
                    e.jsxs("button", {
                      ...
                      children: [e.jsx(Be, { size: 15 }), " Esporta CSV"],
                    }),
                  ],
                }),
              ],
            ...
            h &&
              e.jsxs("div", {
                className: `mb-4 p-3 rounded-lg border text-sm flex items-start justify-between gap-3 ${h.errors.length === 0 ? "bg-green-50 border-green-200 text-green-800" : "bg-amber-50 border-amber-200 text-amber-800"}`,
                children: [
                  e.jsxs("div", {
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          h.created,
                          " soci creati",
                          h.errors.length > 0 && `, ${h.errors.length} errori`,
                        ],
                      }),
                      h.errors.length > 0 &&
                        e.jsxs("ul", {
                              ...
                              e.jsx("tbody", {
                                ...
                                children: R.map((s) => {
                                  ...
                                  return e.jsxs(
                                    ...
                                    {
                                      onClick: () => J(s),
                                      className: `cursor-pointer transition-colors hover:bg-[#177246]/4 ${(b == null ? void 0 : b.id) === s.id ? "bg-[#177246]/8" : ""}`,
                                      children: [
                                        e.jsx("td", {
                                          className: "px-4 py-3",
                                          children: e.jsxs("div", {
                                        ...
                                        e.jsx("td", {
                                          ...
                                          children: e.jsx(Qe, {
                                            size: 15,
                                            className: `transition-colors ${(b == null ? void 0 : b.id) === s.id ? "text-[#177246]" : "text-gray-300"}`,
                                          }),
                                        }),
                                      ],
                                    },
      ...
      b &&
        e.jsx("div", {
          ...
          children: e.jsx(He, { member: b, onClose: () => J(null) }),
        }),
    ],
  });
}
