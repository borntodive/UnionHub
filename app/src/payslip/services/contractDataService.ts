...
import { getContractData as getStaticContractData, applyCorrections, getActiveCorrections } from '../data/contractData';
...
export async function getContractData(
  ...
  try {
    ...
    const backendData = await fetchClaContract(company, role, rank, targetYear, targetMonth);
