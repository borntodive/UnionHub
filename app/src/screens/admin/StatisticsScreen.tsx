    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.mainCard}>
          ...
          <Text style={styles.totalNumber}>{statistics?.totalUsers || 0}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.roleCards}>
            <View style={[styles.roleCard, { backgroundColor: colors.primary + '15' }]}>
              <Plane size={32} color={colors.primary} />
              <Text style={styles.roleNumber}>{statistics?.byRole.pilot || 0}</Text>
              <Text style={styles.roleLabel}>Pilots</Text>
            </View>
            <View style={[styles.roleCard, { backgroundColor: colors.secondary + '15' }]}>
              <UserCheck size={32} color={colors.secondary} />
              <Text style={styles.roleNumber}>{statistics?.byRole.cabin_crew || 0}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.activityCard}>
            ...
            <View style={styles.activityContent}>
              <Text style={styles.activityNumber}>{statistics?.recentRegistrations || 0}</Text>
              <Text style={styles.activityLabel}>New registrations (last 30 days)</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.membershipCards}>
            <View style={styles.membershipCard}>
              ...
              <Text style={styles.membershipNumber}>{statistics?.itudCount || 0}</Text>
              <Text style={styles.membershipLabel}>ITUD Members</Text>
            </View>
            <View style={styles.membershipCard}>
              <FileText size={24} color={colors.warning} />
              <Text style={styles.membershipNumber}>{statistics?.rsaCount || 0}</Text>
