...
- Used by `IssueCategoriesService` and `IssueUrgenciesService`
...
- Push notifications via Expo (silent + visible); silent notifications invalidate TanStack Query cache
