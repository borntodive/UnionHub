...
async function runSeed() {
    ...
    try {
        ...
        const basesRepository = dataSource.getRepository(base_entity_1.Base);
        const defaultBases = [
        ...
        const contractsRepository = dataSource.getRepository(contract_entity_1.Contract);
        ...
        for (const contractData of defaultContracts) {
            ...
            if (!existing) {
                await contractsRepository.save(contractsRepository.create(contractData));
        ...
        const gradesRepository = dataSource.getRepository(grade_entity_1.Grade);
        const defaultGrades = [
            { codice: "SO", nome: "Second Officer", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "JFO", nome: "Junior First Officer", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "FO", nome: "First Officer", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "CPT", nome: "Captain", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "LTC", nome: "Line Training Captain", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "SFI", nome: "Synthetic Flight Instructor", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "LCC", nome: "Line Check Captain", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "TRI", nome: "Type Rating Instructor", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "TRE", nome: "Type Rating Examiner", ruolo: ruolo_enum_1.Ruolo.PILOT },
            { codice: "SEPE", nome: "Senior Purser Europe", ruolo: ruolo_enum_1.Ruolo.CABIN_CREW },
            { codice: "SEPI", nome: "Senior Purser Intercontinental", ruolo: ruolo_enum_1.Ruolo.CABIN_CREW },
            { codice: "CC", nome: "Cabin Crew", ruolo: ruolo_enum_1.Ruolo.CABIN_CREW },
            { codice: "JPU", nome: "Junior Purser", ruolo: ruolo_enum_1.Ruolo.CABIN_CREW },
            { codice: "JU", nome: "Junior", ruolo: ruolo_enum_1.Ruolo.CABIN_CREW },
        ];
        ...
        if (!existingPilotAdmin) {
            ...
            await usersRepository.save(usersRepository.create({
                ...
                ruolo: ruolo_enum_1.Ruolo.PILOT,
                mustChangePassword: true,
                isActive: true,
                nome: "Admin",
                cognome: "Piloti",
        ...
        if (!existingCCAdmin) {
            ...
            await usersRepository.save(usersRepository.create({
                ...
                password: hashedPassword,
                role: user_role_enum_1.UserRole.ADMIN,
                ruolo: ruolo_enum_1.Ruolo.CABIN_CREW,
                mustChangePassword: true,
                isActive: true,
                nome: "Admin",
                cognome: "CabinCrew",
        ...
        const pilotGrades = allGrades.filter(g => g.ruolo === ruolo_enum_1.Ruolo.PILOT);
        const ccGrades = allGrades.filter(g => g.ruolo === ruolo_enum_1.Ruolo.CABIN_CREW);
