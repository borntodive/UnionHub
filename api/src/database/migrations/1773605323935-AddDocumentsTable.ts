...
export class AddDocumentsTable1773605323935 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."documents_status_enum" AS ENUM('draft', 'reviewing', 'approved', 'published')`);
        ...
        await queryRunner.query(`ALTER TABLE "documents" ADD CONSTRAINT "FK_a798977779130148497db432d55" FOREIGN KEY ("createdBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "documents" DROP CONSTRAINT "FK_a798977779130148497db432d55"`);
        await queryRunner.query(`ALTER TABLE "cla_contracts" ALTER COLUMN "effectiveYear" SET DEFAULT EXTRACT(year FROM CURRENT_DATE)`);
        await queryRunner.query(`ALTER TABLE "cla_contracts" ALTER COLUMN "rsa" SET DEFAULT 51.92`);
