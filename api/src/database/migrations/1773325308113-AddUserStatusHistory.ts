...
export class AddUserStatusHistory1773325308113 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_status_history_changetype_enum" AS ENUM('activation', 'deactivation', 'reactivation')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_status_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "changeType" "public"."user_status_history_changetype_enum" NOT NULL, "reason" character varying(500), "changedById" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_b94068e315e962d120caf9a2019" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "deactivatedAt" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_960c87016043c766315aa71a55" ON "grades" ("ruolo") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_409a0298fdd86a6495e23c25c6" ON "users" ("isActive") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8ac6888ff61595169707285b7e" ON "users" ("ruolo") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_7ba14e7bf37b438559072c2cd7" ON "users" ("crewcode") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_status_history" ADD CONSTRAINT "FK_ee538d300bcec6d3c261558a265" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_7a036ade438de3f8aebf9a1edd6" FOREIGN KEY ("baseId") REFERENCES "bases"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_2ff5e319dc6077466ec7f23aba1" FOREIGN KEY ("contrattoId") REFERENCES "contracts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_368f10eb63eb60bccbc37677395" FOREIGN KEY ("gradeId") REFERENCES "grades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_368f10eb63eb60bccbc37677395"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_2ff5e319dc6077466ec7f23aba1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "FK_7a036ade438de3f8aebf9a1edd6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_status_history" DROP CONSTRAINT "FK_ee538d300bcec6d3c261558a265"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7ba14e7bf37b438559072c2cd7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8ac6888ff61595169707285b7e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_409a0298fdd86a6495e23c25c6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_960c87016043c766315aa71a55"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."user_status_history_changetype_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_users_gradeId" FOREIGN KEY ("gradeId") REFERENCES "grades"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_users_contrattoId" FOREIGN KEY ("contrattoId") REFERENCES "contracts"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_users_baseId" FOREIGN KEY ("baseId") REFERENCES "bases"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
}
