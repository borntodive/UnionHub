...
export class CarddavService {
  ...
  async handleRequest(
    ...
    if (!user) {
      res
        .status(401)
        .set("WWW-Authenticate", 'Basic realm="UnionHub CardDAV"')
        .end();
      return;
    }
...
\t\t\t<string>Configura la rubrica contatti UnionHub</string>
\t\t\t<key>PayloadDisplayName</key>
\t\t\t<string>UnionHub Contatti</string>
...
\t</array>
\t<key>PayloadDescription</key>
\t<string>Sincronizza i contatti dei colleghi UnionHub</string>
\t<key>PayloadDisplayName</key>
\t<string>UnionHub</string>
\t<key>PayloadIdentifier</key>
